...
@Component
public class ValidationFailureAction implements Action<KombuchaOrderStatusEnum, KombuchaOrderEventEnum> {
    @Override
    public void execute(StateContext<KombuchaOrderStatusEnum, KombuchaOrderEventEnum> context) {
        ...
        log.debug("Validation Failed for order id:  \""+ kombOrderId+"\"");
    }
}
