...
import com.kombucha.model.order.ValidateOrderRequest;
...
@Component
public class ValidateOrderAction implements Action<KombuchaOrderStatusEnum, KombuchaOrderEventEnum> {
    ...
    public void execute(StateContext<KombuchaOrderStatusEnum, KombuchaOrderEventEnum> context) {
        ...
        log.debug("Sent Validation request to queue: \""+ JmsConfig.VALIDATE_ORDER_QUEUE +"\" for order id: \"" + kombOrderId.toString()+"\"");
